...
.method public closeDeviceManager(Lcom/mediatek/bluetooth/BleDeviceManager;)V
    ...
    const-string/jumbo v1, "closeDeviceManager"
...
.method public closeProfileServiceManager(Lcom/mediatek/bluetooth/BleProfileServiceManager;)V
    ...
    const-string/jumbo v2, "closeProfileServiceManager: proxy="
...
.method public closeProfileServiceProxy(ILcom/mediatek/bluetooth/BleProfileService;)V
    ...
    const-string/jumbo v2, "closeProfileServiceProxy: profile="
    ...
    const-string/jumbo v1, "getProfileService: not match!"
...
.method public getDeviceManager(Landroid/content/Context;Lcom/mediatek/bluetooth/BleDeviceManager$DeviceManagerListener;)Z
    ...
    const-string/jumbo v1, "getDeviceManager"
...
.method public getProfileServiceManager(Landroid/content/Context;Lcom/mediatek/bluetooth/BleProfileServiceManager$ProfileServiceManagerListener;)Z
    ...
    const-string/jumbo v1, "getProfileServiceManager"
...
.method public getProfileServiceProxy(Landroid/content/Context;ILcom/mediatek/bluetooth/BleProfileService$ProfileServiceListener;)Z
    ...
    const-string/jumbo v1, "getProfileService"
    ...
    const-string/jumbo v1, "getProfileService: BLE_PROFILE_TIP"

    invoke-static {v0, v1}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 135
    new-instance v0, Lcom/mediatek/bluetooth/BleTimeProfileService;

    invoke-direct {v0, p1, p3}, Lcom/mediatek/bluetooth/BleTimeProfileService;-><init>(Landroid/content/Context;Lcom/mediatek/bluetooth/BleProfileService$ProfileServiceListener;)V
    ...
    const-string/jumbo v1, "getProfileService: BLE_PROFILE_PXP"

    invoke-static {v0, v1}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 139
    new-instance v0, Lcom/mediatek/bluetooth/BleProximityProfileService;

    invoke-direct {v0, p1, p3}, Lcom/mediatek/bluetooth/BleProximityProfileService;-><init>(Landroid/content/Context;Lcom/mediatek/bluetooth/BleProfileService$ProfileServiceListener;)V
    ...
    const-string/jumbo v1, "getProfileService: BLE_PROFILE_ANP"

    invoke-static {v0, v1}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 145
    new-instance v0, Lcom/mediatek/bluetooth/BleAlertNotificationProfileService;

    invoke-direct {v0, p1, p3}, Lcom/mediatek/bluetooth/BleAlertNotificationProfileService;-><init>(Landroid/content/Context;Lcom/mediatek/bluetooth/BleProfileService$ProfileServiceListener;)V
