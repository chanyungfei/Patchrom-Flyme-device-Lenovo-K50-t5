...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/mediatek/bluetooth/BleFindMeProfile$1;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/mediatek/bluetooth/BleFindMeProfile;)Lcom/mediatek/bluetooth/BleFindMeProfile$ProfileCallback;
    .locals 1
...
.method public final findTarget(I)Z
    ...
    .line 211
    const-string/jumbo v5, "BleFindMeProfile"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "findTarget: this.mGattClientIf = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/mediatek/bluetooth/BleFindMeProfile;->mGattClientIf:Lcom/mediatek/bluetooth/IBleGatt;
    ...
    .line 212
    const-string/jumbo v7, ", this.mProfileID = "
    ...
    .line 213
    iget-object v5, p0, Lcom/mediatek/bluetooth/BleFindMeProfile;->mGattClientIf:Lcom/mediatek/bluetooth/IBleGatt;
    ...
    const-string/jumbo v6, "Invalid level"
    ...
    .line 221
    sget-object v6, Lcom/mediatek/bluetooth/BleGattUuid$Service;->IMMEDIATE_ALERT:Ljava/util/UUID;

    .line 220
    invoke-interface {v5, v6}, Lcom/mediatek/bluetooth/IBleGatt;->getService(Ljava/util/UUID;)Landroid/bluetooth/BluetoothGattService;
    ...
    .line 227
    :cond_3
    sget-object v5, Lcom/mediatek/bluetooth/BleGattUuid$Char;->ALERT_LEVEL:Ljava/util/UUID;
    ...
    invoke-virtual {v7}, Landroid/bluetooth/BluetoothGattService;->getInstanceId()I
    ...
    invoke-virtual {v5}, Landroid/bluetooth/BluetoothGattService;->getClass()Ljava/lang/Class;

    move-result-object v5

    const-string/jumbo v6, "getDevice"
    ...
    const-string/jumbo v7, "-> Char InstanceID:"
    ...
    const-string/jumbo v7, "-> Char Properties:"
    ...
    const-string/jumbo v7, "-> Char Permissions:"
    ...
    invoke-virtual {v0, p1, v5, v8}, Landroid/bluetooth/BluetoothGattCharacteristic;->setValue(III)Z

    .line 250
    iget-object v5, p0, Lcom/mediatek/bluetooth/BleFindMeProfile;->mGattClientIf:Lcom/mediatek/bluetooth/IBleGatt;

    invoke-interface {v5, v8, v0}, Lcom/mediatek/bluetooth/IBleGatt;->writeCharacteristic(ILandroid/bluetooth/BluetoothGattCharacteristic;)Z
...
.method final open()V
    ...
    iget-object v1, p0, Lcom/mediatek/bluetooth/BleFindMeProfile;->mCallback:Lcom/mediatek/bluetooth/IBleGattCallback;
