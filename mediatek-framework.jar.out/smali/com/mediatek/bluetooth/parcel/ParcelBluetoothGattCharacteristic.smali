...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic$1;
    }
.end annotation
...
.method public static from(Landroid/bluetooth/BluetoothGattCharacteristic;Z)Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;
    ...
    .line 341
    :try_start_0
    invoke-virtual {v0}, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->getClass()Ljava/lang/Class;

    move-result-object v1

    const-string/jumbo v2, "mKeySize"
    ...
    .local v10, "gattDesc$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .end local v10    # "gattDesc$iterator":Ljava/util/Iterator;
    :catch_0
    move-exception v7

    .line 345
    .local v7, "e":Ljava/lang/Exception;
    const-string/jumbo v1, "ParcelBluetoothGattCharacteristic"
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, "Parcel Characteristic\n"
    ...
    .line 260
    iget-object v1, p0, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->mUuid:Landroid/os/ParcelUuid;
    ...
    .line 263
    iget v1, p0, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->mInstance:I
    ...
    .line 266
    iget v1, p0, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->mProperties:I
    ...
    .line 269
    iget v1, p0, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->mPermissions:I
...
.method public unpack()Landroid/bluetooth/BluetoothGattCharacteristic;
    ...
    .line 285
    invoke-direct {v3, v7, v8, v9}, Landroid/bluetooth/BluetoothGattCharacteristic;-><init>(Ljava/util/UUID;II)V

    .line 289
    .local v3, "instance":Landroid/bluetooth/BluetoothGattCharacteristic;
    :try_start_0
    const-class v7, Landroid/bluetooth/BluetoothGattCharacteristic;

    const-string/jumbo v8, "mInstance"
    ...
    invoke-virtual {v3, v7}, Landroid/bluetooth/BluetoothGattCharacteristic;->setValue([B)Z

    .line 297
    iget v7, p0, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->mWriteType:I

    invoke-virtual {v3, v7}, Landroid/bluetooth/BluetoothGattCharacteristic;->setWriteType(I)V

    .line 298
    iget v7, p0, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattCharacteristic;->mKeySize:I

    invoke-virtual {v3, v7}, Landroid/bluetooth/BluetoothGattCharacteristic;->setKeySize(I)V
    ...
    .local v6, "parcelDesc$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    check-cast v5, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattDescriptor;

    .line 302
    .local v5, "parcelDesc":Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattDescriptor;
    invoke-virtual {v5}, Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattDescriptor;->unpack()Landroid/bluetooth/BluetoothGattDescriptor;
    ...
    :try_start_1
    invoke-virtual {v2}, Landroid/bluetooth/BluetoothGattDescriptor;->getClass()Ljava/lang/Class;

    move-result-object v7

    const-string/jumbo v8, "setCharacteristic"
    ...
    .line 308
    const-class v10, Landroid/bluetooth/BluetoothGattCharacteristic;
    ...
    .end local v5    # "parcelDesc":Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattDescriptor;
    .end local v6    # "parcelDesc$iterator":Ljava/util/Iterator;
    :catch_0
    move-exception v0

    .line 293
    .local v0, "e":Ljava/lang/Exception;
    const-string/jumbo v7, "ParcelBluetoothGattCharacteristic"
    ...
    .restart local v5    # "parcelDesc":Lcom/mediatek/bluetooth/parcel/ParcelBluetoothGattDescriptor;
    .restart local v6    # "parcelDesc$iterator":Ljava/util/Iterator;
    :catch_1
    move-exception v0
