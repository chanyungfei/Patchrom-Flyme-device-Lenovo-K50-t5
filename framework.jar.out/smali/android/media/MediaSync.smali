...
.method public getTimestamp()Landroid/media/MediaTimestamp;
    ...
    .line 481
    :try_start_0
    new-instance v3, Landroid/media/MediaTimestamp;

    invoke-direct {v3}, Landroid/media/MediaTimestamp;-><init>()V

    .line 482
    .local v3, "timestamp":Landroid/media/MediaTimestamp;
    invoke-direct {p0, v3}, Landroid/media/MediaSync;->native_getTimestamp(Landroid/media/MediaTimestamp;)Z
    ...
    .line 484
    iget-wide v0, v3, Landroid/media/MediaTimestamp;->mediaTimeUs:J

    .line 485
    .local v0, "MediaTimeUs":J
    const-string/jumbo v4, "MediaSync"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "MediaSync getTimestamp ="
    ...
    .line 489
    .end local v0    # "MediaTimeUs":J
    :cond_0
    return-object v7

    .line 491
    .end local v3    # "timestamp":Landroid/media/MediaTimestamp;
    :catch_0
    move-exception v2
