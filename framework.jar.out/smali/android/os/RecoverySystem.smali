...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;)V
    ...
    const-string/jumbo v6, "/data/media/0/"
    ...
    const-string/jumbo v7, "!!! REBOOTING TO INSTALL "
...
.method public static installPackageFromAdb(Landroid/content/Context;Ljava/io/File;)V
    ...
    const-string/jumbo v14, " and persist.sys.switch_storage: "
    ...
    const-string/jumbo v14, "adjust update package path - "
    ...
    .line 397
    const-string/jumbo v14, " | fuse_on: "
    ...
    .line 398
    const-string/jumbo v14, " | isSwitchStorage: "
    ...
    .line 404
    const-string/jumbo v12, "/data/media/0/"
    ...
    .line 412
    .local v2, "filenameArg":Ljava/lang/String;
    const-string/jumbo v0, "--auto_ota_upgrade"
    ...
    const-string/jumbo v13, "--auto_ota_upgrade"
    ...
    .line 402
    :cond_2
    const-string/jumbo v7, "/sdcard2/"

    .restart local v7    # "mPathToExternalSdcard":Ljava/lang/String;
    goto :goto_1
.end method
...
.method private static readySystemPreloadUpgrade()V
    ...
    const-string/jumbo v8, "/system/preload/"
    ...
    const-string/jumbo v9, "No files in sys preload dir "
    ...
    const-string/jumbo v8, "/cache/lastpreload"

    invoke-direct {v4, v8}, Ljava/io/FileWriter;-><init>(Ljava/lang/String;)V

    .line 714
    .local v4, "lpfile":Ljava/io/FileWriter;
    :try_start_0
    new-instance v6, Ljava/lang/StringBuilder;
    ...
    .line 723
    .local v5, "plstr":Ljava/lang/String;
    const-string/jumbo v7, "RecoverySystem"
    ...
    const-string/jumbo v9, "readySystemPreloadUpgrade write plstr : "
    ...
    .line 727
    .end local v3    # "i":I
    .end local v5    # "plstr":Ljava/lang/String;
...
.method public static rebootFactoryWipeData(Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "--factory_wipe_data\n--locale="
...
.method public static rebootWipeUserDataEx(Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "--ex_wipe_data\n--locale="
