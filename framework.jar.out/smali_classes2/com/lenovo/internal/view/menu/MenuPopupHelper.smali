...
# direct methods
.method static synthetic -get0(Lcom/lenovo/internal/view/menu/MenuPopupHelper;)Lcom/lenovo/internal/view/menu/MenuBuilder;
    .locals 1
...
.method static synthetic -get1(Lcom/lenovo/internal/view/menu/MenuPopupHelper;)Z
    .locals 1
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-static {v0}, Lcom/lenovo/internal/view/menu/MenuPopupHelper$MenuAdapter;->-get0(Lcom/lenovo/internal/view/menu/MenuPopupHelper$MenuAdapter;)Lcom/lenovo/internal/view/menu/MenuBuilder;
...
.method public tryShow()Z
    ...
    .line 134
    new-instance v2, Llenovo/widget/ListPopupWindow;

    iget-object v3, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mContext:Landroid/content/Context;

    iget v4, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopupStyleAttr:I

    invoke-direct {v2, v3, v6, v4}, Llenovo/widget/ListPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    .line 135
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v2, p0}, Llenovo/widget/ListPopupWindow;->setOnDismissListener(Llenovo/widget/PopupWindow$OnDismissListener;)V

    .line 136
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v2, p0}, Llenovo/widget/ListPopupWindow;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 137
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    iget-object v3, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mAdapter:Lcom/lenovo/internal/view/menu/MenuPopupHelper$MenuAdapter;

    invoke-virtual {v2, v3}, Llenovo/widget/ListPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 138
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v2, v5}, Llenovo/widget/ListPopupWindow;->setModal(Z)V
    ...
    .line 145
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iput-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    invoke-virtual {v2, v1}, Llenovo/widget/ListPopupWindow;->setAnchorView(Landroid/view/View;)V

    .line 149
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    iget v3, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mDropDownGravity:I

    invoke-virtual {v2, v3}, Llenovo/widget/ListPopupWindow;->setDropDownGravity(I)V

    .line 154
    iget-boolean v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mHasContentWidth:Z

    if-nez v2, :cond_1

    .line 157
    iget v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopupMaxWidth:I

    iput v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mContentWidth:I

    .line 159
    iput-boolean v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mHasContentWidth:Z

    .line 162
    :cond_1
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    iget v3, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mContentWidth:I

    invoke-virtual {v2, v3}, Llenovo/widget/ListPopupWindow;->setContentWidth(I)V
    ...
    invoke-virtual {v2, v3}, Llenovo/widget/ListPopupWindow;->setInputMethodMode(I)V

    .line 164
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v2}, Llenovo/widget/ListPopupWindow;->show()V

    .line 165
    iget-object v2, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v2}, Llenovo/widget/ListPopupWindow;->getListView()Landroid/widget/ListView;
