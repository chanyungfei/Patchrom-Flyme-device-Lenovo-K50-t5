...
# direct methods
.method static synthetic -get0(Lcom/lenovo/internal/view/menu/ActionMenuItemView;)Lcom/lenovo/internal/view/menu/MenuItemImpl;
    .locals 1
...
.method static synthetic -get1(Lcom/lenovo/internal/view/menu/ActionMenuItemView;)Lcom/lenovo/internal/view/menu/MenuBuilder$ItemInvoker;
    .locals 1
...
.method static synthetic -get2(Lcom/lenovo/internal/view/menu/ActionMenuItemView;)Lcom/lenovo/internal/view/menu/ActionMenuItemView$PopupCallback;
    .locals 1
...
.method private updateTextButtonVisibility()V
    ...
    iget-boolean v2, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mExpandedFormat:Z
...
.method public hasText()Z
    ...
    invoke-virtual {v1}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    :cond_1
    iget-object v9, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mItemData:Lcom/lenovo/internal/view/menu/MenuItemImpl;

    invoke-virtual {v9}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->getTitle()Ljava/lang/CharSequence;
...
.method public onlyText()Z
    ...
    invoke-virtual {v1}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->showsTextAsAction()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 206
    .local v0, "height":I
    iget v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mMaxIconSize:I
    ...
    .end local v1    # "scale":F
    :cond_1
    invoke-virtual {p1, v7, v7, v3, v0}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 220
    .end local v0    # "height":I
    .end local v3    # "width":I
    :cond_2
    iget-object v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mItemData:Lcom/lenovo/internal/view/menu/MenuItemImpl;

    invoke-virtual {v4}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->showsTextAsAction()Z

    move-result v4

    if-eqz v4, :cond_3

    iget-boolean v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mAllowTextWithIcon:Z
    ...
    .line 222
    invoke-virtual {p0, v6, p1, v6, v6}, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    .line 223
    iget v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mHasIconTextSize:I

    int-to-float v4, v4

    invoke-virtual {p0, v7, v4}, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->setTextSize(IF)V

    .line 224
    iget v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mMiddlePadding:I

    invoke-virtual {p0, v4}, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->setCompoundDrawablePadding(I)V

    .line 225
    iget v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mPaddings:I

    iget v5, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mTopPaddings:I

    iget v6, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mPaddings:I

    invoke-virtual {p0, v4, v5, v6, v7}, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->setPadding(IIII)V
    ...
    .line 227
    :cond_4
    invoke-virtual {p0, p1, v6, v6, v6}, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    .line 228
    iget v4, p0, Lcom/lenovo/internal/view/menu/ActionMenuItemView;->mNormalTextSize:I
