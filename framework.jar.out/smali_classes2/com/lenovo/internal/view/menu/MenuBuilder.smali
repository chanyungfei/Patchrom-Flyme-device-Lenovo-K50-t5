...
.method private dispatchPresenterUpdate(Z)V
    ...
    .line 275
    .local v1, "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/lenovo/internal/view/menu/MenuPresenter;>;"
    invoke-virtual {v1}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/lenovo/internal/view/menu/MenuPresenter;

    .line 276
    .local v0, "presenter":Lcom/lenovo/internal/view/menu/MenuPresenter;
    if-nez v0, :cond_1
    ...
    .line 279
    :cond_1
    invoke-interface {v0, p1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->updateMenuView(Z)V

    goto :goto_0

    .line 282
    .end local v0    # "presenter":Lcom/lenovo/internal/view/menu/MenuPresenter;
    .end local v1    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/lenovo/internal/view/menu/MenuPresenter;>;"
    :cond_2
...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 344
    invoke-interface {v2, v1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method private dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 317
    :cond_2
    invoke-interface {v1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->getId()I
    ...
    .line 319
    invoke-interface {v1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method private dispatchSubMenuSelected(Lcom/lenovo/internal/view/menu/SubMenuBuilder;Lcom/lenovo/internal/view/menu/MenuPresenter;)Z
    ...
    .line 301
    invoke-interface {v0, p1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->onSubMenuSelected(Lcom/lenovo/internal/view/menu/SubMenuBuilder;)Z
...
.method private setHeaderInternal(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    .line 1201
    :goto_0
    invoke-virtual {p0, v3}, Lcom/lenovo/internal/view/menu/MenuBuilder;->onItemsChanged(Z)V
...
.method public final close(Z)V
    ...
    .line 996
    :cond_1
    invoke-interface {v0, p0, p1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->onCloseMenu(Lcom/lenovo/internal/view/menu/MenuBuilder;Z)V
...
.method public collapseItemActionView(Lcom/lenovo/internal/view/menu/MenuItemImpl;)Z
    ...
    .line 1336
    :cond_3
    invoke-interface {v1, p0, p1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->collapseItemActionView(Lcom/lenovo/internal/view/menu/MenuBuilder;Lcom/lenovo/internal/view/menu/MenuItemImpl;)Z
    ...
    .line 1343
    iput-object v5, p0, Lcom/lenovo/internal/view/menu/MenuBuilder;->mExpandedItem:Lcom/lenovo/internal/view/menu/MenuItemImpl;
...
.method public expandItemActionView(Lcom/lenovo/internal/view/menu/MenuItemImpl;)Z
    ...
    .line 1314
    :cond_2
    invoke-interface {v1, p0, p1}, Lcom/lenovo/internal/view/menu/MenuPresenter;->expandItemActionView(Lcom/lenovo/internal/view/menu/MenuBuilder;Lcom/lenovo/internal/view/menu/MenuItemImpl;)Z
...
.method public flagActionItems()V
    ...
    check-cast v4, Lcom/lenovo/internal/view/menu/MenuPresenter;

    .line 1126
    .local v4, "presenter":Lcom/lenovo/internal/view/menu/MenuPresenter;
    if-nez v4, :cond_1
    ...
    .line 1129
    :cond_1
    invoke-interface {v4}, Lcom/lenovo/internal/view/menu/MenuPresenter;->flagActionItems()Z
    ...
    .line 1133
    .end local v0    # "flagged":Z
    .end local v4    # "presenter":Lcom/lenovo/internal/view/menu/MenuPresenter;
    .end local v5    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/lenovo/internal/view/menu/MenuPresenter;>;"
    :cond_2
    if-eqz v0, :cond_4
    ...
    invoke-virtual {v2}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->isActionButton()Z
...
.method public performItemAction(Landroid/view/MenuItem;Lcom/lenovo/internal/view/menu/MenuPresenter;I)Z
    ...
    invoke-virtual {p0, v7}, Lcom/lenovo/internal/view/menu/MenuBuilder;->close(Z)V
    ...
    .end local v2    # "provider":Llenovo/view/ActionProvider;
    :cond_1
    return v6

    .line 952
    .restart local v0    # "invoked":Z
    .restart local v2    # "provider":Llenovo/view/ActionProvider;
    :cond_2
    const/4 v3, 0x0
    ...
    .line 960
    new-instance v5, Lcom/lenovo/internal/view/menu/SubMenuBuilder;

    invoke-virtual {p0}, Lcom/lenovo/internal/view/menu/MenuBuilder;->getContext()Landroid/content/Context;

    move-result-object v6

    invoke-direct {v5, v6, p0, v1}, Lcom/lenovo/internal/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Lcom/lenovo/internal/view/menu/MenuBuilder;Lcom/lenovo/internal/view/menu/MenuItemImpl;)V

    invoke-virtual {v1, v5}, Lcom/lenovo/internal/view/menu/MenuItemImpl;->setSubMenu(Lcom/lenovo/internal/view/menu/SubMenuBuilder;)V
...
.method public removeGroup(I)V
    ...
    .line 538
    invoke-direct {p0, v0, v5}, Lcom/lenovo/internal/view/menu/MenuBuilder;->removeItemAtInt(IZ)V
...
.method public removeMenuPresenter(Lcom/lenovo/internal/view/menu/MenuPresenter;)V
    ...
    .line 264
    .local v0, "item":Lcom/lenovo/internal/view/menu/MenuPresenter;
    if-eqz v0, :cond_1
    ...
    .line 261
    .end local v0    # "item":Lcom/lenovo/internal/view/menu/MenuPresenter;
    .end local v1    # "ref":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/lenovo/internal/view/menu/MenuPresenter;>;"
    :cond_2
    return-void
.end method
