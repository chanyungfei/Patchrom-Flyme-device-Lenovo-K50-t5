...
.field private static final PROPERTY_VSIM_ENABLE:Ljava/lang/String; = "gsm.external.sim.enabled"
...
.method static synthetic -set1(Lcom/android/internal/telephony/dataconnection/DcTracker;Landroid/app/ProgressDialog;)Landroid/app/ProgressDialog;
    .locals 0
...
.method private applyNewState(Lcom/android/internal/telephony/dataconnection/ApnContext;ZZ)V
    ...
    const-string/jumbo v5, "applyNewState: block during IRAT: apnContext = "
...
.method private buildWaitingApns(Ljava/lang/String;I)Ljava/util/ArrayList;
    ...
    .line 3496
    iget-object v8, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mGsmDctExt:Lcom/mediatek/common/telephony/IGsmDCTExt;
    ...
    invoke-interface {v8, v9}, Lcom/mediatek/common/telephony/IGsmDCTExt;->customizeApn(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v8, v0}, Lcom/mediatek/common/telephony/IGsmDCTExt;->customizeApn(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private createApnListWithRecord(Landroid/database/Cursor;Lcom/android/internal/telephony/uicc/IccRecords;)Ljava/util/ArrayList;
    ...
    const-string/jumbo v5, "[IRAT_DcTracker] createApnListWithRecord: X result="
...
.method private deactivateLinkDownPdn(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .prologue
    .line 5372
    const-string/jumbo v0, "[IRAT_DcTracker]deactivateLinkDownPdn..."
...
.method private isCdmaFallbackCase(II)Z
    ...
    const-string/jumbo v4, "[IRAT_DcTracker]isIratFallbackCase: sourceFamily = "
    ...
    .line 5037
    const-string/jumbo v4, ", targetFamily = "
...
.method private makeInitialAttachApn()Lcom/android/internal/telephony/dataconnection/ApnSetting;
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] makeInitialAttachApn with operator = "
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] makeInitialAttachApn: selection="
    ...
    .line 4850
    invoke-direct {p0, v9, v13}, Lcom/android/internal/telephony/dataconnection/DcTracker;->createApnListWithRecord(Landroid/database/Cursor;Lcom/android/internal/telephony/uicc/IccRecords;)Ljava/util/ArrayList;

    move-result-object v8

    .line 4852
    .local v8, "apnSettings":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/ApnSetting;>;"
    if-eqz v8, :cond_2
    ...
    .end local v12    # "potentialApnSetting":Lcom/android/internal/telephony/dataconnection/ApnSetting;
    .local v7, "apnSetting$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_1
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] makeInitialAttachApn: iaApnSetting = "
    ...
    .line 4867
    const-string/jumbo v1, ",potentialApnSetting = "
    ...
    .line 4880
    .end local v7    # "apnSetting$iterator":Ljava/util/Iterator;
    .end local v8    # "apnSettings":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/ApnSetting;>;"
    :cond_2
    :goto_2
    ...
    .line 4887
    iget-object v10, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mInitialAttachApnSetting:Lcom/android/internal/telephony/dataconnection/ApnSetting;
    ...
    .restart local v12    # "potentialApnSetting":Lcom/android/internal/telephony/dataconnection/ApnSetting;
    :cond_5
    ...
    .restart local v7    # "apnSetting$iterator":Ljava/util/Iterator;
    .restart local v8    # "apnSettings":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/ApnSetting;>;"
...
.method private onApnChangedDone()V
    ...
    const-string/jumbo v4, "onApnChanged: createAllApnList and cleanUpAllConnections: isDisconnected = "
    ...
    const-string/jumbo v4, "onApnChanged: phone.getsubId="
    ...
    const-string/jumbo v4, "getDefaultDataSubId()"
...
.method private onDataConnectionAttached()V
    ...
    .line 996
    const-string/jumbo v1, "onDataConnectionAttached: cdma phone receive Lte attached,ignore and wait updateIccRecordAndApn"
    ...
    const-string/jumbo v2, "onDataConnectionAttached targetRat = "
...
.method private onIratDataRatChanged(II)V
    ...
    const-string/jumbo v2, "[IRAT_DcTrakcer] onIratDataRatChanged: mIsDuringIrat = "
    ...
    .line 4688
    const-string/jumbo v1, "[IRAT_DcTrakcer] Ignore RAT change during IRAT."
    ...
    .line 4693
    const-string/jumbo v1, "[MD_IRAT_DcTrakcer] De-register on C2K/LTE network, do thing."
    ...
    .line 4695
    const-string/jumbo v1, "[MD_IRAT_DcTrakcer] First register on C2K/LTE network."
    ...
    .line 4702
    const-string/jumbo v1, "[MD_IRAT_DcTrakcer] Fallback happens."
    ...
    const-string/jumbo v1, "CdmaFallbackHappened"
    ...
    .line 4709
    const-string/jumbo v1, "CdmaIratEnded"
    ...
    :cond_3
    const-string/jumbo v1, "[MD_IRAT_DcTrakcer] Normal data RAT change."
...
.method private onLteRecordsLoaded()V
    ...
    .line 4791
    const-string/jumbo v0, "onLteRecordsLoaded setInitialApn: but isDuringIrat."
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] onLteRecordsLoaded: operatorNumeric = "
    ...
    .line 4800
    :cond_1
    const-string/jumbo v0, "onLteRecordsLoaded setInitialApn: but no operator numeric"
    ...
    .line 4805
    iput-object v8, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mSvlteOperatorNumeric:Ljava/lang/String;
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] onLteRecordsLoaded: mInitialAttachApnSetting = "
    ...
    invoke-direct {v6, v8}, Lcom/mediatek/internal/telephony/dataconnection/IaExtendParam;-><init>(Ljava/lang/String;)V
    ...
    .line 4812
    iget-object v0, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mSvlteIaApnSetting:Lcom/android/internal/telephony/dataconnection/ApnSetting;
    ...
    iput-boolean v0, v6, Lcom/mediatek/internal/telephony/dataconnection/IaExtendParam;->mCanHandleIms:Z
    ...
    .line 4813
    invoke-interface/range {v0 .. v7}, Lcom/mediatek/internal/telephony/ltedc/IRilDcArbitrator;->setInitialAttachApn(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/Object;Landroid/os/Message;)V
    ...
    .line 4821
    :cond_5
    const-string/jumbo v0, "[IRAT_DcTracker] onLteRecordsLoaded: There in no available apn, use empty"
...
.method private registerForEventsAfterPhoneCreated()V
    ...
    const-string/jumbo v3, "[IRAT_DcTracker] registerForEventsAfterPhoneCreated: mIratController = "
    ...
    .line 5003
    const-string/jumbo v3, ", mIratDataSwitchHelper = "
...
.method private registerForVoiceCallEventPeer()V
    ...
    .line 5264
    const-string/jumbo v8, "Register both side for csPhone update"
...
.method private resetDcAndApnContext()V
    ...
    const-string/jumbo v3, "[IRAT_DcTracker] resetDcAndApnContext: apnContext = "
...
.method private setupDataOnConnectableApns(Ljava/lang/String;Lcom/android/internal/telephony/dataconnection/DcTracker$RetryFailures;)V
    ...
    .line 1162
    const-string/jumbo v5, "DO NOT setup data until clean up finished for IRAT."
...
.method private trySetupData(Lcom/android/internal/telephony/dataconnection/ApnContext;Ljava/util/ArrayList;)Z
    ...
    .line 1222
    iget-boolean v8, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mSetupDataBlocked:Z

    .line 1221
    if-eqz v8, :cond_0

    .line 1223
    const-string/jumbo v8, "DO NOT setup data until clean up finished for IRAT."
...
.method private unregisterForEventsAfterPhoneCreated()V
    ...
    .line 5011
    const-string/jumbo v2, "[IRAT_DcTracker] unregisterForEventsAfterPhoneCreated."
...
.method private unregisterForVoiceCallEventPeer()V
    ...
    .line 5300
    const-string/jumbo v8, "Unregister both side for csPhone update"
...
.method private updateIccRecord(I)V
    ...
    const-string/jumbo v4, "[IRAT_DcTracker] updateIccRecord: targetRat = "
    ...
    .line 4940
    const-string/jumbo v4, ", newIccRecords = "
    ...
    .line 4945
    const-string/jumbo v3, "[IRAT_DcTracker] Removing stale icc objects."
    ...
    .line 4950
    const-string/jumbo v3, "[IRAT_DcTracker] New records found"
...
.method private updateIccRecordAndApn(II)V
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] updateIccRecordAndApn: sourceRat = "
...
.method private updateInitialAttachApnForSvlte()V
    ...
    const-string/jumbo v2, "[IRAT_DcTracker] updateInitialAttachForSvlte: newIaApnSetting="
...
.method protected cleanUpAllConnections(ZLjava/lang/String;)Z
    ...
    .line 1392
    .local v3, "specificdisable":Z
    const-string/jumbo v4, "ro.mtk_flight_mode_power_off_md"
...
.method public getAnyDataEnabled()Z
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPolicyDataEnabled:Z
    ...
    const-string/jumbo v5, "getAnyDataEnabled1 return false. mInternalDataEnabled = "
    ...
    .line 893
    const-string/jumbo v5, ", mPolicyDataEnabled = "
    ...
    const-string/jumbo v3, "getAnyDataEnabled1 return true, apn = "
    ...
    :cond_5
    :try_start_3
    const-string/jumbo v2, "getAnyDataEnabled1 return false"
...
.method public getAnyDataEnabled(Z)Z
    ...
    const-string/jumbo v3, "getAnyDataEnabled2 return false. mInternalDataEnabled = "
    ...
    .line 922
    const-string/jumbo v3, ", checkUserDataEnabled = "
    ...
    .line 924
    const-string/jumbo v3, ", mPolicyDataEnabled = "
    ...
    const-string/jumbo v4, "getAnyDataEnabled2 return true, apn = "
    ...
    :cond_7
    :try_start_3
    const-string/jumbo v2, "getAnyDataEnabled2 return false"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 3624
    :cond_0
    const-string/jumbo v17, "handleMessage: Ignore GSM msgs since GSM phone is inactive"
    ...
    .line 3634
    :sswitch_1
    const-string/jumbo v17, "simLoaded"
    ...
    new-instance v18, Lcom/android/internal/telephony/dataconnection/DcTracker$2;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/internal/telephony/dataconnection/DcTracker$2;-><init>(Lcom/android/internal/telephony/dataconnection/DcTracker;)V
    ...
    :goto_1
    const-string/jumbo v17, "EVENT_APN_CHANGED_DONE"
    ...
    .line 3665
    const-string/jumbo v17, "ims apn changed"
    ...
    .line 3738
    :cond_b
    const-string/jumbo v17, "EVENT_CLEAN_UP_CONNECTION request w/o apn context, call super"
    ...
    .line 3796
    :sswitch_12
    const-string/jumbo v17, "[IRAT_DcTracker] Retry to setup data for IRAT."
    ...
    .line 3798
    const-string/jumbo v17, "CdmaFallbackHappened"
    ...
    const-string/jumbo v18, "EVENT_RESET_PDP_DONE cid="
    ...
    .line 3813
    const-string/jumbo v17, "EVENT_REMOVE_RESTRICT_EUTRAN"
    ...
    .line 3815
    const-string/jumbo v17, "psRestrictDisabled"
    ...
    const-string/jumbo v18, "EVENT_LTE_ACCESS_STRATUM_STATE networkType = "
    ...
    const-string/jumbo v18, "EVENT_LTE_ACCESS_STRATUM_STATE lteAccessStratumDataState = "
    ...
    :cond_10
    const-string/jumbo v17, "DCT"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v19, "LteAccessStratumState exception: "
...
.method protected isDataAllowed(ZZ)Z
    ...
    iget-boolean v10, v0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mIsPsRestricted:Z

    .line 1057
    .local v10, "psRestricted":Z
    invoke-static {}, Landroid/telephony/TelephonyManager;->getDefault()Landroid/telephony/TelephonyManager;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/mediatek/internal/telephony/ltedc/svlte/SvltePhoneProxy;->getCallTracker()Lcom/android/internal/telephony/CallTracker;
    ...
    .line 1084
    .local v16, "statePeer":Lcom/android/internal/telephony/PhoneConstants$State;
    if-nez v3, :cond_4
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/telephony/dataconnection/DcController;->isPcModemConnected()Z
    ...
    const-string/jumbo v18, "isDataAllowed: phoneType = "
    ...
    const-string/jumbo v18, ", PcModemConnected = "
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/dataconnection/DcController;->isPcModemConnected()Z
    ...
    .end local v16    # "statePeer":Lcom/android/internal/telephony/PhoneConstants$State;
    :catchall_0
    move-exception v18
    ...
    .line 1092
    .restart local v16    # "statePeer":Lcom/android/internal/telephony/PhoneConstants$State;
    :cond_18
    move-object/from16 v0, p0
    ...
    const-string/jumbo v18, " - PhoneState= "
    ...
    const-string/jumbo v18, " - PeerPhoneState= "
    ...
    const-string/jumbo v18, " - Concurrent voice and data with peer not allowed"
...
.method public isVsimActive(I)Z
    ...
    .line 5359
    const-string/jumbo v4, "gsm.external.sim.enabled"
    ...
    const-string/jumbo v5, "Vsim enabled on phone "
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    .line 2688
    const-string/jumbo v31, "onDataSetupComplete: no connection to DC, handle as error"
    ...
    const-string/jumbo v34, "onDataSetupComplete: No apnContext"
    ...
    const-string/jumbo v34, "onDataSetupComplete: success apn="
    ...
    const-string/jumbo v34, "default"
    ...
    .line 2713
    const-string/jumbo v31, "gsm.defaultpdpcontext.active"
    ...
    .line 2715
    const-string/jumbo v31, "onDataSetupComplete: PREFERED APN is null"
    ...
    const-string/jumbo v34, "onDataSetupComplete: SETUP complete type="
    ...
    const-string/jumbo v34, "onDataSetupComplete: NumberFormatException making ProxyProperties ("
    ...
    const-string/jumbo v34, "onDataSetupComplete: successful, BUT send connected to prov apn as mIsProvisioning:"
    ...
    .line 2757
    const-string/jumbo v34, " && (isProvisioningApn:"
    ...
    .line 2775
    const-string/jumbo v31, "android.intent.action.DATA_CONNECTION_CONNECTED_TO_PROVISIONING_APN"
    ...
    .line 2777
    const-string/jumbo v31, "apnType"
    ...
    .line 2782
    const-string/jumbo v31, "linkProperties"
    ...
    .line 2790
    const-string/jumbo v31, "networkCapabilities"
    ...
    const-string/jumbo v34, "avatar data collect, setup data fail cause =  "
    ...
    const-string/jumbo v34, "onDataSetupComplete: error apn=%s cause=%s"
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/telephony/TelephonyManager;->getNetworkType()I
    ...
    .line 2864
    const-string/jumbo v31, "onDataSetupComplete: WaitingApns.size=%d WaitingApnsPermFailureCountDown=%d"
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    .line 3007
    const-string/jumbo v4, "onDisconnectDone: not to retry for IRAT."
    ...
    const-string/jumbo v5, "onDisconnectDone: attached, ready and retry after disconnect, reason:"
...
.method public onIratEnded(Ljava/lang/Object;)V
    ...
    const-string/jumbo v3, "[IRAT_DcTracker] onIratEnded: info = "
    ...
    .line 4752
    const-string/jumbo v2, "CdmaIratEnded"
    ...
    .line 4762
    const-string/jumbo v2, "[IRAT_DcTracker] onIratEnded: start polling"
    ...
    const-string/jumbo v3, "[IRAT_DcTracker] onIratEnded: mHasPendingApnChange: "
    ...
    .line 4768
    const-string/jumbo v3, ", mHasPendingInitialApnRequest: "
    ...
    .line 4769
    const-string/jumbo v3, ", mHasPendingLteRecordLoaded: "
...
.method public onIratStarted(Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "[IRAT_DcTracker] onIratStarted: info = "
    ...
    .line 4722
    const-string/jumbo v0, "[IRAT_DcTracker] onIratStarted: stop polling"
...
.method protected onRoamingOff()V
    ...
    const-string/jumbo v1, "onRoamingOff mDataRoamingEnabled="
    ...
    .line 2540
    const-string/jumbo v1, ", mUserDataEnabled="
...
.method protected onRoamingOn()V
    ...
    const-string/jumbo v1, "onRoamingOn mDataRoamingEnabled="
...
.method protected onUpdateIcc()V
    ...
    const-string/jumbo v10, "onUpdateIcc: family = "
    ...
    .line 3899
    const-string/jumbo v10, ", newIccRecords = "
    ...
    .line 3903
    const-string/jumbo v9, "Removing stale icc objects."
    ...
    .line 3908
    const-string/jumbo v9, "New records found"
    ...
    const-string/jumbo v10, "[IRAT_DcTracker] Register for LTE IccRecords: newLteIccRecords = "
    ...
    .line 3925
    const-string/jumbo v10, ", oldLteIccRecords = "
    ...
    .line 3932
    const-string/jumbo v9, "Removing stale LTE icc objects."
    ...
    .line 3943
    const-string/jumbo v9, "New LTE records found"
    ...
    .line 3962
    const-string/jumbo v7, "Removing stale UiccCardApplication objects."
    ...
    .line 3968
    const-string/jumbo v7, "New UiccCardApplication found"
...
.method protected onVoiceCallEnded()V
    ...
    .line 3106
    const-string/jumbo v0, "onVoiceCallEnded: default data disable, cleanup default apn."
    ...
    invoke-virtual {p0, v1, v2, v0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->onCleanUpConnection(ZILjava/lang/String;)V
    ...
    .line 3113
    const-string/jumbo v0, "onVoiceCallEnded start polling"
...
.method protected onVoiceCallEndedPeer()V
    ...
    .line 3150
    :cond_1
    const-string/jumbo v0, "onVoiceCallEndedPeer start polling"
...
.method protected onVoiceCallStartedPeer()V
    ...
    const-string/jumbo v1, "onVoiceCallStartedPeer mPhone="
    ...
    .line 3134
    :cond_1
    const-string/jumbo v0, "onVoiceCallStartedPeer stop polling"
...
.method public updateCsPhoneForSvlte(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string/jumbo v2, "[IRAT_DcTracker] updateCsPhoneForSvlte: newCsPhone = "
...
.method public updatePhoneIfNeeded(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    const-string/jumbo v3, "[IRAT_DcTracker]updatePhoneIfNeeded: mPhone = "
    ...
    .line 5115
    const-string/jumbo v3, ", newPhone="
    ...
    .line 5115
    const-string/jumbo v3, ", mIsPsRestricted = "
    ...
    .line 5120
    const-string/jumbo v2, "[IRAT_DcTracker] Doesn\'t need to update phone for same phone type."
