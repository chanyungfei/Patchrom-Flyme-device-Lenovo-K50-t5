...
.method private setInitialAttachApnForSvlte()V
    ...
    .line 2606
    const-string/jumbo v0, "[IRAT_DcTracker] Pend setInitialApn due to IRAT is on-going"
    ...
    .line 2612
    .local v8, "ltePhone":Lcom/android/internal/telephony/PhoneBase;
    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v1, "[IRAT_DcTracker] setInitialAttachApnForSvlte: apn = "
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->mSvlteOperatorNumeric:Ljava/lang/String;

    invoke-direct {v6, v0}, Lcom/mediatek/internal/telephony/dataconnection/IaExtendParam;-><init>(Ljava/lang/String;)V
    ...
    .line 2616
    iget-object v0, v8, Lcom/android/internal/telephony/PhoneBase;->mCi:Lcom/android/internal/telephony/CommandsInterface;
...
.method private showDataDialog(Z)V
    .locals 9
    .param p1, "enabled"    # Z
    ...
    const-string/jumbo v7, "feeAgain"
    ...
    const-string/jumbo v7, "dctrackerbase showDataDialog() setUpWizard = "
    ...
    const-string/jumbo v7, "showDataDialog Exception ex = "
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->onSetUserDataEnabled(Z)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1262
    :sswitch_e
    const-string/jumbo v13, "EVENT_VOICE_CALL_STARTED_PEER"
    ...
    .line 1266
    :sswitch_f
    const-string/jumbo v13, "EVENT_VOICE_CALL_ENDED_PEER"
    ...
    invoke-direct {v0, v6}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->showDataDialog(Z)V
...
.method protected onActionIntentSimStateChanged(Landroid/content/Intent;)V
    ...
    const-string/jumbo v4, "onActionIntentSimStateChanged: phoneId="
    ...
    .line 714
    const-string/jumbo v4, " state LOADED and record load completed"
...
.method protected setInitialAttachApn()V
    ...
    const-string/jumbo v3, "[IRAT_DcTracker] DO NOT setInitialApn for CDMA: numeric = "
    ...
    const-string/jumbo v3, "[IRAT_DcTracker] GSM setInitialAttachApn: numeric = "
    ...
    .line 2372
    .restart local v18    # "r":Lcom/android/internal/telephony/uicc/IccRecords;
    if-eqz v18, :cond_7
