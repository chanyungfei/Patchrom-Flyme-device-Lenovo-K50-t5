...
.field private mImsConfHostConnection:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 131
    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mImsConfHostConnection:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    .line 649
    const-string v22, "case 1 : new Call appear"
    ...
    const-string v23, "poll: pendingMO="
    ...
    .line 688
    const-string v22, "MO/MT conflict! MO should be hangup by MD"
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/telephony/gsm/GsmConnection;->setCnapName(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->DmCheckIfCallCanComing(Lcom/android/internal/telephony/gsm/GsmConnection;)Z
    ...
    invoke-virtual {v0, v15, v1}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->setForwardingAddressToConnection(ILcom/android/internal/telephony/Connection;)V
    ...
    .line 721
    invoke-virtual {v14}, Lcom/android/internal/telephony/Connection;->isMultipartyBeforeHandover()Z
    ...
    const-string v23, "SRVCC: goes to conference case."
    ...
    iput-object v14, v0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mImsConfHostConnection:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    const-string v23, "SRVCC: goes to normal call case."
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/telephony/gsm/GSMPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    .line 764
    const-string v22, "case 2 : old Call disappear"
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/gsm/GsmCall;->isIdle()Z
    ...
    sget-object v23, Lcom/android/internal/telephony/Call$State;->WAITING:Lcom/android/internal/telephony/Call$State;
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->CallIndicationEnd()V
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->clearForwardingAddressVariables(I)V
    ...
    .line 793
    const-string v22, "case 3 : old Call replaced"
    ...
    .line 815
    const-string v22, "case 4 : old Call update"
    ...
    .line 861
    const-string v22, "notifyNewRingingConnection"
    ...
    const-string v23, "dropped during poll size = "
    ...
    .line 896
    :cond_1d
    const-string v22, "local hangup or invalid number"
    ...
    iget-object v0, v0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mImsConfHostConnection:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    .line 907
    const-string v22, "srvcc: notify new participant connections"
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->notifyConferenceConnectionsConfigured(Ljava/util/ArrayList;)V
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/gsm/GsmCallTracker;->mImsConfHostConnection:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    const-string v23, "handlePollCalls - disconnect hoConn= "
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(I)Z
    ...
    .line 912
    const-string v22, "srvcc: only one connection, consider it as a normal call SRVCC"
    ...
    const-string v23, "SRVCC: abnormal case, no participant connections."
    ...
    .line 951
    const-string v22, "notifyUnknownConnection"
    ...
    .line 959
    const-string v22, "notifyPreciseCallStateChanged"
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/gsm/GsmCallTrackerHelper;->getCurrentTotalConnections()I
