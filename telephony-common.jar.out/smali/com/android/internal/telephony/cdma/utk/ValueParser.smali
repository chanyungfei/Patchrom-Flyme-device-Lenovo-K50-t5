...
.method static retrieveAlphaId(Lcom/android/internal/telephony/cdma/utk/ComprehensionTlv;)Ljava/lang/String;
    ...
    .end local v0    # "e":Ljava/lang/IndexOutOfBoundsException;
    :cond_0
    const-string/jumbo v4, "Defualt Message"
...
.method static retrieveBearerDesc(Lcom/android/internal/telephony/cdma/utk/ComprehensionTlv;)Lcom/android/internal/telephony/cdma/utk/BearerDescription;
    ...
    invoke-static {v4, v6, v1, v9, v8}, Ljava/lang/System;->arraycopy([BI[BII)V

    .line 516
    .end local v1    # "bearerParams":[B
    :cond_0
...
.method static retrieveDataToSend(Lcom/android/internal/telephony/cdma/utk/ComprehensionTlv;)[B
    ...
    invoke-static {v3, v4, v0, v6, v5}, Ljava/lang/System;->arraycopy([BI[BII)V
    :try_end_0
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_0 .. :try_end_0} :catch_0
...
.method static retrieveItemsIconId(Lcom/android/internal/telephony/cdma/utk/ComprehensionTlv;)Lcom/android/internal/telephony/cdma/utk/ItemsIconId;
    ...
    invoke-static {v9, v10}, Lcom/android/internal/telephony/cdma/utk/UtkLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v9, v1, Lcom/android/internal/telephony/cdma/utk/ItemsIconId;->recordNumbers:[I
...
.method static retrieveOtherAddress(Lcom/android/internal/telephony/cdma/utk/ComprehensionTlv;)Lcom/android/internal/telephony/cdma/utk/OtherAddress;
    ...
    .line 626
    :try_start_1
    new-instance v4, Lcom/android/internal/telephony/cdma/utk/OtherAddress;

    invoke-direct {v4}, Lcom/android/internal/telephony/cdma/utk/OtherAddress;-><init>()V
    :try_end_1
    ...
    .local v4, "otherAddress":Lcom/android/internal/telephony/cdma/utk/OtherAddress;
    :try_start_2
    iput v0, v4, Lcom/android/internal/telephony/cdma/utk/OtherAddress;->addressType:I
    ...
    invoke-static {v6, v8, v5, v10, v9}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    iput-object v9, v4, Lcom/android/internal/telephony/cdma/utk/OtherAddress;->address:Ljava/net/InetAddress;
    :try_end_2
    ...
    .line 644
    .end local v4    # "otherAddress":Lcom/android/internal/telephony/cdma/utk/OtherAddress;
    ...
    .end local v3    # "otherAddress":Lcom/android/internal/telephony/cdma/utk/OtherAddress;
    .restart local v4    # "otherAddress":Lcom/android/internal/telephony/cdma/utk/OtherAddress;
    :catch_2
    move-exception v1
...
.method static retrieveTextString(Lcom/android/internal/telephony/cdma/utk/ComprehensionTlv;)Ljava/lang/String;
    ...
    invoke-static {v3, v7, v5}, Lcom/android/internal/telephony/cdma/utk/ValueParser;->utkStringFieldToString([BII)Ljava/lang/String;
...
.method private static utkStringFieldToString([BII)Ljava/lang/String;
    ...
    invoke-direct {v6, p0, v9, v10, v11}, Ljava/lang/String;-><init>([BIILjava/lang/String;)V
    :try_end_0
    ...
    .line 382
    .end local v3    # "isucs2":Z
    .end local v4    # "len":I
    .restart local v5    # "ret":Ljava/lang/String;
    .restart local v8    # "ucslen":I
    :catch_0
    move-exception v2
