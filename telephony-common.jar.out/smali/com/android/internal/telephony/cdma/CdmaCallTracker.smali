...
.method private checkMtFindNewRinging(Lcom/android/internal/telephony/DriverCall;I)Lcom/android/internal/telephony/Connection;
    ...
    const-string/jumbo v7, "getInterceptionEnabledSetting:"
    ...
    const-string/jumbo v6, "Notify new ring "
    ...
    const-string/jumbo v5, "CdmaCallTracker"
    ...
    const-string/jumbo v7, "Phantom call appeared "
...
.method private dialThreeWay(Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private formatDialNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "before format number = "
    ...
    const-string/jumbo v6, "after replace pluscode dial number = "
    ...
    const-string/jumbo v4, "cdma_cnir"
    ...
    const-string/jumbo v6, "after add dialNumber with CNIR number = \'"
...
.method private handleCallAccepted()V
    ...
    .line 1575
    .local v2, "count":I
    const-string/jumbo v3, "CdmaCallTracker"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "handleCallAccepted, fgcall count:"
...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    const-string/jumbo v20, "CdmaCallTracker"

    new-instance v21, Ljava/lang/StringBuilder;

    invoke-direct/range {v21 .. v21}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v22, "handleCallWaitingInfo before format number = "
    ...
    const-string/jumbo v22, "handleCallWaitingInfo after format number = "
    ...
    .line 1133
    invoke-static/range {v20 .. v20}, Lcom/mediatek/common/mom/IMobileManagerService$Stub;->asInterface(Landroid/os/IBinder;)Lcom/mediatek/common/mom/IMobileManagerService;
    ...
    const-string/jumbo v21, "getInterceptionEnabledSetting:"
    ...
    invoke-interface/range {v21 .. v21}, Lcom/mediatek/common/mom/IMobileManagerService;->getInterceptionEnabledSetting()Z
    ...
    const-string/jumbo v20, "phoneNumber"
    ...
    .line 1141
    const-string/jumbo v20, "callType"
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getSubId()I

    move-result v21

    invoke-static/range {v21 .. v21}, Landroid/telephony/SubscriptionManager;->getSlotId(I)I
    ...
    .line 1152
    .end local v18    # "parameter":Landroid/os/Bundle;
    :cond_2
    :goto_0
    new-instance v20, Ljava/lang/StringBuilder;
    ...
    const-string/jumbo v21, "MoMS check result:"
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/cdma/CdmaCall;->getConnections()Ljava/util/List;

    move-result-object v14

    .line 1167
    .local v14, "fgConns":Ljava/util/List;
    const/4 v13, 0x0

    .line 1168
    .local v13, "fgConnCount":I
    if-eqz v14, :cond_3
    ...
    .line 1174
    .local v12, "fgConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    invoke-virtual {v12}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getAddress()Ljava/lang/String;
    ...
    .line 1175
    invoke-virtual {v12}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getRealAcceptTime()J
    ...
    const-string/jumbo v21, "handleCallWaitingInfo CallWaiting invalid, return"
    ...
    .end local v12    # "fgConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    .end local v13    # "fgConnCount":I
    .end local v14    # "fgConns":Ljava/util/List;
    .end local v15    # "i":I
    :catch_0
    move-exception v10
    ...
    const-string/jumbo v21, "MoMS suppressing notification failed!"
    ...
    const-string/jumbo v22, "hangup failed, exception:"
    ...
    .restart local v12    # "fgConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    .restart local v13    # "fgConnCount":I
    .restart local v14    # "fgConns":Ljava/util/List;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/cdma/CdmaCall;->getLatestConnection()Lcom/android/internal/telephony/Connection;
    ...
    .line 1182
    .local v16, "lastRingConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    if-eqz v16, :cond_7
    ...
    const-string/jumbo v21, "handleCallWaitingInfo skip duplicate callwaiting"
    ...
    .end local v14    # "fgConns":Ljava/util/List;
    .end local v15    # "i":I
    .end local v16    # "lastRingConn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    .line 1206
    new-instance v20, Lcom/android/internal/telephony/cdma/CdmaConnection;
...
.method private handleEcmTimer(I)V
    ...
    const-string/jumbo v1, "handleEcmTimer,mIsEcmTimerCanceled="
...
.method private shouldNotifyMtCall()Z
    ...
    .line 1647
    sget-boolean v2, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->MTK_SWITCH_ANTENNA_SUPPORT:Z
    ...
    const-string/jumbo v5, "shouldNotifyMtCall, mPhone:"
...
.method acceptCall()V
    ...
    const-string/jumbo v8, "acceptCall: incoming..."
    ...
    const-string/jumbo v8, "acceptCall: callwaiting count = "
    ...
    const-string/jumbo v8, "acceptCall: ringConn number = "
...
.method dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    .line 275
    const-string/jumbo v9, "CdmaCallTracker"

    const-string/jumbo v10, "send EVENT_CDMA_DIAL_THREEWAY_DELAY"
    ...
    const-string/jumbo v10, "exit emergency callback mode when dial threeway"
    ...
    invoke-interface {v9, v0, p2, v11, v10}, Lcom/android/internal/telephony/CommandsInterface;->emergencyDial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1220
    const-string/jumbo v13, "CdmaCallTracker"

    const-string/jumbo v14, "Ignoring events received on inactive CdmaPhone"
    ...
    const-string/jumbo v15, "unexpected event:"
    ...
    const-string/jumbo v14, "unexpected event not handled"
    ...
    const-string/jumbo v14, "Event EVENT_POLL_CALLS_RESULT Received"
    ...
    .line 1251
    .local v12, "vendorCause":Ljava/lang/String;
    move-object/from16 v0, p1
    ...
    .line 1260
    const-string/jumbo v14, "Exception during getLastCallFailCause, assuming normal disconnect"

    .line 1259
    invoke-static {v13, v14}, Landroid/telephony/Rlog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 1267
    .end local v12    # "vendorCause":Ljava/lang/String;
    :goto_1
    const/4 v9, 0x0
    ...
    invoke-virtual {v4, v3, v12}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onRemoteDisconnect(ILjava/lang/String;)V
    ...
    .end local v9    # "i":I
    .end local v10    # "s":I
    .restart local v12    # "vendorCause":Ljava/lang/String;
    :cond_2
    iget-object v7, v2, Landroid/os/AsyncResult;->result:Ljava/lang/Object;

    check-cast v7, Lcom/android/internal/telephony/LastCallFailCause;

    .line 1263
    .local v7, "failCause":Lcom/android/internal/telephony/LastCallFailCause;
    iget v3, v7, Lcom/android/internal/telephony/LastCallFailCause;->causeCode:I

    .line 1264
    .restart local v3    # "causeCode":I
    iget-object v12, v7, Lcom/android/internal/telephony/LastCallFailCause;->vendorCause:Ljava/lang/String;

    .local v12, "vendorCause":Ljava/lang/String;
    goto :goto_1

    .line 1275
    .end local v7    # "failCause":Lcom/android/internal/telephony/LastCallFailCause;
    .end local v12    # "vendorCause":Ljava/lang/String;
    ...
    .line 1290
    const-string/jumbo v13, "persist.radio.hd.voice"
    ...
    .line 1291
    .local v8, "hdVoiceEnabled":I
    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v14, "persist.radio.hd.voice = "
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->log(Ljava/lang/String;)V
    ...
    invoke-interface {v13, v14, v15}, Lcom/android/internal/telephony/CommandsInterface;->setSpeechCodecInfo(ZLandroid/os/Message;)V
    ...
    invoke-direct {v0, v14}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->formatDialNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v14, "Event EVENT_CALL_WAITING_INFO_CDMA Received"
    ...
    const-string/jumbo v14, "exception happened on Blank Flash for 3-way call"
    ...
    .line 1356
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->handleCallAccepted()V

    .line 1357
    const-string/jumbo v13, "CdmaCallTracker"

    const-string/jumbo v14, "EVENT_CDMA_CALL_ACCEPTED"
    ...
    const-string/jumbo v15, "EVENT_CDMA_DIAL_THREEWAY_DELAY, dialString:"
    ...
    invoke-direct {v0, v6}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->formatDialNumber(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->obtainMessage(I)Landroid/os/Message;

    move-result-object v14

    .line 1367
    invoke-interface {v13, v5, v14}, Lcom/android/internal/telephony/CommandsInterface;->sendCDMAFeatureCode(Ljava/lang/String;Landroid/os/Message;)V
    ...
    iget-object v11, v13, Landroid/os/AsyncResult;->userObj:Ljava/lang/Object;

    check-cast v11, Ljava/lang/String;

    .line 1375
    .local v11, "threeWayDialString":Ljava/lang/String;
    const-string/jumbo v13, "CdmaCallTracker"
    ...
    const-string/jumbo v15, "dial threeway after exit ECM pendingCallInEcm:"
    ...
    .line 1376
    const-string/jumbo v15, ", dialString:"
    ...
    invoke-virtual {v0, v15}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->obtainMessage(I)Landroid/os/Message;

    move-result-object v15

    invoke-interface {v13, v14, v15}, Lcom/android/internal/telephony/CommandsInterface;->sendCDMAFeatureCode(Ljava/lang/String;Landroid/os/Message;)V

    .line 1379
    move-object/from16 v0, p0

    invoke-direct {v0, v11}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->dialThreeWay(Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v13, v0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->unsetOnThreeWayEcmExitResponse(Landroid/os/Handler;)V

    goto/16 :goto_0

    .line 1389
    .end local v11    # "threeWayDialString":Ljava/lang/String;
    :pswitch_f
    move-object/from16 v0, p1
    ...
    iput v13, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mSpeechCodecType:I
    ...
    const-string/jumbo v14, "handle EVENT_SPEECH_CODEC_INFO : "
    ...
    iget v14, v0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mSpeechCodecType:I
    ...
    invoke-virtual {v13, v14}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifySpeechCodecInfo(I)V
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v27, "before format number = "
    ...
    const-string/jumbo v27, "after format number = "
    ...
    :cond_1
    :goto_2
    const-string/jumbo v26, "ril.cdma.inecmmode"
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaCall;I)V
    ...
    const-string/jumbo v3, "CdmaCall "
...
.method hangupActiveCall()V
    ...
    .prologue
    .line 1639
    const-string/jumbo v0, "hangupActiveCall"
