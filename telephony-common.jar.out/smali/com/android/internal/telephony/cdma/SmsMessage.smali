...
.method public static calculateLength(Ljava/lang/CharSequence;ZZ)Lcom/android/internal/telephony/GsmAlphabet$TextEncodingDetails;
    ...
    const-string/jumbo v3, "send-function call this for segment calculate, will transfer this string to bearerdata calcTextEncodingDetails again, but divide in parent class will first bearerdata calcTextEncodingDetails and then use this string"
    ...
    const-string/jumbo v3, "search calculateLengthCDMA for help!"
...
.method public static getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/android/internal/telephony/SmsHeader;III)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    const-string/jumbo v12, "viacode: getSubmitPdu, null sms text or destination address. do nothing."
    ...
    const-string/jumbo v12, "viacode: getSubmitPdu, destination address is empty. do nothing."
    ...
    const-string/jumbo v12, "viacode: getSubmitPdu, message text is empty. do nothing."
    ...
    iput-object v0, v10, Lcom/android/internal/telephony/cdma/sms/UserData;->payloadStr:Ljava/lang/String;

    .line 1358
    move-object/from16 v0, p4

    iput-object v0, v10, Lcom/android/internal/telephony/cdma/sms/UserData;->userDataHeader:Lcom/android/internal/telephony/SmsHeader;
    ...
    iput-boolean v11, v10, Lcom/android/internal/telephony/cdma/sms/UserData;->msgEncodingSet:Z

    .line 1372
    invoke-static {p1}, Lcom/android/internal/telephony/cdma/SmsMessage;->processPlusCodeForSMSMO(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v12, "got null or empty address after processPlusCodeForSMSMO()!"
    ...
    const-string/jumbo v12, "viacode: getSubmitPdu, CdmaSmsAddress parse error."
    ...
    iput-boolean v11, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->validityPeriodRelativeSet:Z
    ...
    .line 1411
    :goto_2
    iput-object v10, v2, Lcom/android/internal/telephony/cdma/sms/BearerData;->userData:Lcom/android/internal/telephony/cdma/sms/UserData;
    ...
    const-string/jumbo v12, "viacode: getSubmitPdu, encoded bearerData error."
    ...
    const-string/jumbo v13, "viacode: creating SubmitPdu failed: "
...
.method private static getTimeZoneOffset()I
    ...
    const-string/jumbo v5, "Get operatorNumeric:"
    ...
    const-string/jumbo v4, "China telecom or macao telecom, set timezoneOffset as 4 * 8."
    ...
    .line 335
    :cond_1
    const-string/jumbo v3, "cdma.operator.ltmoffset"
    ...
    const-string/jumbo v4, "Get network timezoneOffset failed, will use default 0"
    ...
    const-string/jumbo v4, "Get network timezoneOffset successly"
...
.method public static newFromParcel(Landroid/os/Parcel;)Lcom/android/internal/telephony/cdma/SmsMessage;
    ...
    const-string/jumbo v12, "after format addr.numberOfDigits = "
...
.method private parsePduFromEfRecord([B)V
    ...
    const-string/jumbo v23, "parameterId = "
    ...
    const-string/jumbo v23, ", parameterLen = "
...
.method private static privateGetSubmitPdu(Ljava/lang/String;ZLcom/android/internal/telephony/cdma/sms/UserData;J)Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;
    ...
    const-string/jumbo v12, "privateGetSubmitPdu, CdmaSmsAddress parse error."
    ...
    iput v11, v8, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->messageType:I
    ...
    iput v11, v8, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->bearerReply:I
    ...
    iget v11, v8, Lcom/android/internal/telephony/cdma/sms/SmsEnvelope;->teleService:I
    ...
    invoke-virtual {v6, v11}, Ljava/io/DataOutputStream;->write(I)V
    ...
    invoke-virtual {v6, v11, v13, v12}, Ljava/io/DataOutputStream;->write([BII)V
    ...
    invoke-virtual {v6, v7, v12, v11}, Ljava/io/DataOutputStream;->write([BII)V
    ...
    iput-object v11, v10, Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;->encodedMessage:[B

    .line 1175
    const/4 v11, 0x0

    iput-object v11, v10, Lcom/android/internal/telephony/cdma/SmsMessage$SubmitPdu;->encodedScAddress:[B
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static processPlusCodeForSMSMO(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "destAddrStr is null or empty, just return!"
    ...
    const-string/jumbo v2, "got null or empty address after via plus code process"
