...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;Lcom/android/internal/telephony/cdma/CdmaCallTracker;Lcom/android/internal/telephony/cdma/CdmaCall;)V
    ...
    const-string/jumbo v2, "Create for call waiting, mAddress = "
...
.method disconnectCauseFromCode(I)I
    ...
    .line 419
    const-string/jumbo v5, ", uiccAppState:"
...
.method public hangup(I)V
    ...
    const-string/jumbo v1, "hangup RingingConn with cause = "
    ...
    .line 1031
    const-string/jumbo v1, ", and ringCall state = "
...
.method onConnectedInOrOut()V
    ...
    const-string/jumbo v2, "mParent.mConnections.size():"
...
.method update(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/cdma/CdmaConnection;->parentFromDCState(Lcom/android/internal/telephony/DriverCall$State;)Lcom/android/internal/telephony/cdma/CdmaCall;
    ...
    const-string/jumbo v7, ", newParent= "
    ...
    const-string/jumbo v7, " mNumberConverted "
    ...
    .line 499
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mAddress:Ljava/lang/String;

    iget-object v7, p1, Lcom/android/internal/telephony/DriverCall;->number:Ljava/lang/String;

    invoke-static {v6, v7}, Lcom/android/internal/telephony/cdma/CdmaConnection;->equalsHandlesNulls(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 500
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mConvertedNumber:Ljava/lang/String;
    ...
    const-string/jumbo v7, "Update, wasConnectingInOrOut="
    ...
    .line 510
    :cond_7
    const-string/jumbo v6, "update: update number because number changed by network!"
    ...
    iput-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaConnection;->mAddress:Ljava/lang/String;
    ...
    .line 508
    :cond_8
    const-string/jumbo v6, "update: do not update number according because pluscode transfer!"
    ...
    invoke-virtual {v6, p0, p1}, Lcom/android/internal/telephony/cdma/CdmaCall;->update(Lcom/android/internal/telephony/cdma/CdmaConnection;Lcom/android/internal/telephony/DriverCall;)Z
