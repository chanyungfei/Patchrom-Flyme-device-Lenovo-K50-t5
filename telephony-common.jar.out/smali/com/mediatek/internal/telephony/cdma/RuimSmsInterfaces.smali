...
.method public static convertSubmitpduToPdu([B)[B
    ...
    const-string/jumbo v19, "RuimSmsInterfaces 1.0"
    ...
    const-string/jumbo v21, "convertSubmitpduToPdu: read from submitpdu failed: "
    ...
    const-string/jumbo v20, "get datas from submitpdu done! to write datas to a deliverpdu"
    ...
    const-string/jumbo v21, "convertSubmitpduToPdu: conversion from object to byte array failed: "
    ...
    const-string/jumbo v20, "convertSubmitpduToPdu: will never reach here"
...
.method public static makeCDMASmsRecordData(I[BZ)[B
    ...
    .line 201
    const-string/jumbo v3, "RuimSmsInterfaces 1.0"
    ...
    .line 204
    const-string/jumbo v4, "call makeCDMASmsRecordData to convert a submitpdu to a deliverpdu, so parse process can run directly"
    ...
    const-string/jumbo v4, "the param pdu already be one uim sms record pdu with length"
