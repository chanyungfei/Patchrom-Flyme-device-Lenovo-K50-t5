...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$1;,
        Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$2;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)F
    .locals 1
...
.method static synthetic -get1(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AutomaticBrightnessHandler;
    .locals 1
...
.method static synthetic -get2(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)J
    .locals 2
...
.method static synthetic -get3(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)Landroid/hardware/Sensor;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)Z
    .locals 1
...
.method static synthetic -get5(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)Landroid/hardware/SensorEventListener;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)I
    .locals 1
...
.method static synthetic -get7(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)J
    .locals 2
...
.method static synthetic -get8(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)Landroid/hardware/SensorManager;
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)Lcom/android/server/display/autobrightness/SplineManager;
    .locals 1
...
.method static synthetic -set0(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;J)J
    .locals 1
...
.method static synthetic -set1(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;J)J
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;JF)V
    .locals 1
    .param p1, "time"    # J
    .param p3, "lux"    # F
...
.method static synthetic -wrap1(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)V
    .locals 0
...
.method static synthetic -wrap2(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;Z)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$Callbacks;Landroid/os/Looper;Landroid/hardware/SensorManager;Landroid/util/Spline;IIIF)V
    ...
    const-string/jumbo v2, "mLightSensorRegisterThread"
...
.method private calculateAmbientLux(J)F
    ...
    .line 471
    const-string/jumbo v10, "AutoBrightnessLenovo"
...
.method private preUpdateAutoBrightness(Z)V
    ...
    .line 609
    const-string/jumbo v2, ") return false. Not change brightness."
    ...
    .line 613
    const-string/jumbo v2, ") return true"
...
.method private setAmbientLux(F)V
    ...
    .prologue
    .line 460
    const-string/jumbo v0, "--AutoBrightnessLenovo.SetAmbientLux"
...
.method private setLightSensorEnabled(Z)Z
    ...
    const-string/jumbo v2, "setLightSensorEnabled: enable ="
    ...
    .line 402
    iput-boolean v4, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mLightSensorEnabled:Z
    ...
    iput-wide v0, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mLightSensorEnableTime:J
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$LightSensorRegisterHandler;->sendEmptyMessage(I)Z
    ...
    invoke-virtual {v0, v5, v2, v3}, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AutomaticBrightnessHandler;->sendEmptyMessageDelayed(IJ)Z

    .line 407
    iget-object v0, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mSplineManager:Lcom/android/server/display/autobrightness/SplineManager;

    invoke-virtual {v0}, Lcom/android/server/display/autobrightness/SplineManager;->onEnabled()V
    ...
    iput-wide v0, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mLightSensorRegisterTime:J
    ...
    .line 415
    iput-boolean v3, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mLightSensorEnabled:Z

    .line 416
    iput-boolean v3, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mAmbientLuxValid:Z

    .line 417
    iput v3, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mRecentLightSamples:I

    .line 418
    iget-object v0, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mAmbientLightRingBuffer:Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AmbientLightRingBuffer;

    invoke-virtual {v0}, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AmbientLightRingBuffer;->clear()V

    .line 419
    iget-object v0, p0, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo;->mHandler:Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AutomaticBrightnessHandler;

    invoke-virtual {v0, v4}, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AutomaticBrightnessHandler;->removeMessages(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$LightSensorRegisterHandler;->sendEmptyMessage(I)Z
...
.method private updateAmbientLux(J)V
    ...
    .line 550
    :cond_0
    const-string/jumbo v3, "AutoBrightnessLenovo"
    ...
    .line 577
    const-string/jumbo v12, "AutoBrightnessLenovo"
    ...
    .line 581
    const-string/jumbo v13, ", mAmbientLightRingBuffer.mCount="
    ...
    invoke-static {v13}, Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AmbientLightRingBuffer;->-get0(Lcom/android/server/display/autobrightness/AutoBrightnessLenovo$AmbientLightRingBuffer;)I
...
.method private updateAutoBrightness(Z)V
    ...
    .line 630
    const-string/jumbo v5, "AutoBrightnessLenovo"
    ...
    const-string/jumbo v7, "updateAutoBrightness: gamma="
    ...
    .line 663
    const-string/jumbo v5, "AutoBrightnessLenovo.UpdateAutoBrightness"
    ...
    const-string/jumbo v7, "same brightness("
    ...
    .line 675
    const-string/jumbo v7, "). Not change brightness."
...
.method public configure(ZFZ)V
    ...
    .line 290
    const-string/jumbo v1, "AutoBrightnessLenovo"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "configure: enable = "
    ...
    const-string/jumbo v4, ", adjustment = "
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    .line 308
    const-string/jumbo v6, "Automatic Brightness Controller Configuration:"
    ...
    const-string/jumbo v7, "  mScreenBrightnessRangeMaximum="
    ...
    .line 314
    const-string/jumbo v6, "Automatic Brightness Controller State:"
    ...
    const-string/jumbo v7, "  mLightSensor="
    ...
    const-string/jumbo v7, "  mTwilight.getCurrentState()="
    ...
    const-string/jumbo v7, "  mLightSensorEnabled="
    ...
    const-string/jumbo v7, "  mBrighteningLuxThreshold="
    ...
    const-string/jumbo v7, "  mDarkeningLuxThreshold="
    ...
    const-string/jumbo v7, "  mLastObservedLuxTime="
    ...
    const-string/jumbo v7, "  mRecentLightSamples="
    ...
    const-string/jumbo v7, "  mScreenAutoBrightness="
    ...
    const-string/jumbo v7, "  mScreenAutoBrightnessAdjustment="
    ...
    const-string/jumbo v7, "  mLastScreenAutoBrightnessGamma="
    ...
    .line 332
    const-string/jumbo v6, "SplineManager:"
    ...
    const-string/jumbo v7, "  mLastNonZeroLuxTime ="
...
.method public getAutomaticScreenBrightness()I
    ...
    const-string/jumbo v2, "getAutomaticScreenBrightness = "
...
.method public getLastAutoBrightness()I
    ...
    const-string/jumbo v2, "getLastAutoBrightness = "
...
.method public onStateChange(F)V
    ...
    const-string/jumbo v2, "onStateChange: current = "
    ...
    const-string/jumbo v2, ", entryLux = "
