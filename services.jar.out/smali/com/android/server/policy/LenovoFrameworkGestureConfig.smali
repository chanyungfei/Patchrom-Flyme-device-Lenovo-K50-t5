.class public Lcom/android/server/policy/LenovoFrameworkGestureConfig;
...
.field public static final LENOVO_FLAG_PATH:Ljava/lang/String; = "/sys/board_properties/lenovo_flag"
...
.field public static final TPD_SUSPEND_STATUS:Ljava/lang/String; = "/sys/board_properties/tpd_suspend_status"
...
.method static constructor <clinit>()V
    ...
    .line 35
    :goto_0
    sput-object v0, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->DEFAULT_PACKAGE_E:Ljava/lang/String;
    ...
    .line 38
    const-string/jumbo v0, "com.google.android.apps.chrome.Main"

    .line 37
    :goto_1
    sput-object v0, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->DEFAULT_CLASS_E:Ljava/lang/String;
    ...
    .line 65
    const-string/jumbo v0, "com.google.android.music"

    .line 64
    :goto_2
    sput-object v0, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->DEFAULT_PACKAGE_M:Ljava/lang/String;
    ...
    .line 67
    const-string/jumbo v0, "com.android.music.activitymanagement.TopLevelActivity"

    .line 66
    :goto_3
    sput-object v0, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->DEFAULT_CLASS_M:Ljava/lang/String;

    .line 87
    invoke-static {}, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->placeholder()Z

    move-result v0

    sput-boolean v0, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->LENOVO_GESTURE_PICK_UP_SUPPORT:Z
    ...
    sput-boolean v0, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->LENOVO_GESTURE_WAVE_HAND_SUPPORT:Z

    .line 95
    invoke-static {}, Lcom/android/server/policy/LenovoFrameworkGestureConfig;->initConstants()V
    ...
    .line 36
    :cond_0
    const-string/jumbo v0, "com.lenovo.browser"

    goto :goto_0

    .line 38
    :cond_1
    const-string/jumbo v0, "com.lenovo.browser.BrowserActivity"

    goto :goto_1

    .line 65
    :cond_2
    const-string/jumbo v0, "com.lenovo.music"

    goto :goto_2

    .line 67
    :cond_3
    const-string/jumbo v0, "com.lenovo.music.ui.LeAppLoadingActivity"
...
.method private static initConstants()V
    ...
    .line 99
    const-string/jumbo v0, "ro.lenovo_gesture_pickup"
    ...
    .line 100
    const-string/jumbo v0, "ro.lenovo_gesture_wave_hand"
...
.method public static setTpdStatus(Z)V
    ...
    .prologue
    .line 105
    const-string/jumbo v5, "LenovoGesture_Config"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "setSlideUnlock enabled="
    ...
    const-string/jumbo v5, "/sys/board_properties/tpd_suspend_status"
