...
# static fields
.field private static final DEBUG_BOOT_PHASE:Z = true
...
.method public startBootPhase(I)V
    ...
    const-string v9, "SystemServiceManager"

    const-string v10, "DEBUG_BOOT_PHASE, DON\'T PANIC!"
    ...
    :cond_0
    iget v9, p0, Lcom/android/server/SystemServiceManager;->mCurrentPhase:I
    ...
    const-string v10, "Next phase must be larger than previous"
    ...
    const-string v11, "Starting phase "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget v11, p0, Lcom/android/server/SystemServiceManager;->mCurrentPhase:I
    ...
    .line 143
    iget-object v9, p0, Lcom/android/server/SystemServiceManager;->mServices:Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v9}, Lcom/android/server/SystemService;->onBootPhase(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v11, "Failed to boot service "
    ...
    const-string v11, ": onBootPhase threw an exception during phase "
    ...
    .end local v6    # "service":Lcom/android/server/SystemService;
    :cond_2
    return-void
.end method
