...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0, v11}, Lcom/android/settings/location/LocationSettings;->addPreferencesFromResource(I)V
    ...
    iput-object v11, p0, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;

    .line 272
    iget-object v11, p0, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;

    new-instance v12, Lcom/android/settings/location/LocationSettings$3;

    invoke-direct {v12, p0, v0}, Lcom/android/settings/location/LocationSettings$3;-><init>(Lcom/android/settings/location/LocationSettings;Lcom/android/settings/SettingsActivity;)V
    ...
    iput-object v11, p0, Lcom/android/settings/location/LocationSettings;->mAGPSSettingPreference:Landroid/preference/Preference;
    ...
    .line 304
    iget-object v11, p0, Lcom/android/settings/location/LocationSettings;->mAGPSSettingPreference:Landroid/preference/Preference;
    ...
    iget-object v12, p0, Lcom/android/settings/location/LocationSettings;->mAGPSSettingPreferenceClickListener:Landroid/preference/Preference$OnPreferenceClickListener;
    ...
    iget-object v12, p0, Lcom/android/settings/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;
    ...
    iput-object v11, p0, Lcom/android/settings/location/LocationSettings;->mCategoryRecentLocationRequests:Landroid/preference/PreferenceCategory;
    ...
    .line 365
    iget-object v11, p0, Lcom/android/settings/location/LocationSettings;->mCategoryRecentLocationRequests:Landroid/preference/PreferenceCategory;

    invoke-direct {p0, v7, v11}, Lcom/android/settings/location/LocationSettings;->addPreferencesSorted(Ljava/util/List;Landroid/preference/PreferenceGroup;)V
    ...
    iget-object v11, p0, Lcom/android/settings/location/LocationSettings;->mUm:Landroid/os/UserManager;

    const-string v12, "no_share_location"

    iget-object v13, p0, Lcom/android/settings/location/LocationSettings;->mManagedProfile:Landroid/os/UserHandle;
    ...
    invoke-virtual {p0, v11}, Lcom/android/settings/location/LocationSettings;->setHasOptionsMenu(Z)V
    ...
    .line 368
    .end local v9    # "stream":Ljava/io/FileInputStream;
    .restart local v6    # "recentApps":Lcom/android/settings/location/RecentLocationApps;
