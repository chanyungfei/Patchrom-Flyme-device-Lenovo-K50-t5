...
.method private constructor <init>(Landroid/security/IKeyChainService;Lcom/lenovo/settings/TrustedCredentialsSettings$TrustedCertificateAdapterCommons;Lcom/lenovo/settings/TrustedCredentialsSettings$Tab;Ljava/lang/String;Ljava/security/cert/X509Certificate;I)V
    ...
    .line 604
    new-instance v4, Lcom/android/settings/SslCertificate;

    invoke-direct {v4, p5}, Lcom/android/settings/SslCertificate;-><init>(Ljava/security/cert/X509Certificate;)V

    iput-object v4, p0, Lcom/lenovo/settings/TrustedCredentialsSettings$CertHolder;->mSslCert:Lcom/android/settings/SslCertificate;

    .line 606
    iget-object v4, p0, Lcom/lenovo/settings/TrustedCredentialsSettings$CertHolder;->mSslCert:Lcom/android/settings/SslCertificate;

    invoke-virtual {v4}, Lcom/android/settings/SslCertificate;->getIssuedTo()Lcom/android/settings/SslCertificate$DName;

    move-result-object v4

    invoke-virtual {v4}, Lcom/android/settings/SslCertificate$DName;->getCName()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/settings/SslCertificate$DName;->getOName()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/settings/SslCertificate$DName;->getUName()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/settings/SslCertificate$DName;->getDName()Ljava/lang/String;
...
.method static synthetic access$2700(Lcom/lenovo/settings/TrustedCredentialsSettings$CertHolder;)Lcom/android/settings/SslCertificate;
    .locals 1
    .param p0, "x0"    # Lcom/lenovo/settings/TrustedCredentialsSettings$CertHolder;

    .prologue
    .line 578
    iget-object v0, p0, Lcom/lenovo/settings/TrustedCredentialsSettings$CertHolder;->mSslCert:Lcom/android/settings/SslCertificate;
