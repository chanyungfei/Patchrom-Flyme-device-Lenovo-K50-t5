...
.field private static final CREATE_SPLITBAR_DISTANCE:I = 0xc8
...
.method public onScroll(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    .line 519
    .local v5, "y2":I
    iget v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mItemX:I

    sub-int v0, v3, v6

    .line 520
    .local v0, "deltaX":I
    iget v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mItemY:I

    sub-int v1, v5, v6

    .line 522
    .local v1, "deltaY":I
    iget-boolean v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mCanDrag:Z

    if-eqz v6, :cond_0

    iget-boolean v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mDragging:Z

    if-nez v6, :cond_0

    iget v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mHitPos:I

    if-ne v6, v7, :cond_2

    iget v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mFlingHitPos:I
    ...
    .line 524
    iget v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mDragInitMode:I
    ...
    iget v7, p0, Lcom/lenovo/settings/dslv/DragSortController;->mTouchSlop:I

    if-le v6, v7, :cond_3

    iget-boolean v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mSortEnabled:Z
    ...
    invoke-virtual {p0, v6, v0, v1}, Lcom/lenovo/settings/dslv/DragSortController;->startDrag(III)Z
    ...
    iget-boolean v6, p0, Lcom/lenovo/settings/dslv/DragSortController;->mRemoveEnabled:Z

    if-eqz v6, :cond_0

    .line 528
    iput-boolean v9, p0, Lcom/lenovo/settings/dslv/DragSortController;->mIsRemoving:Z
    ...
    .line 537
    iput-boolean v8, p0, Lcom/lenovo/settings/dslv/DragSortController;->mCanDrag:Z
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {v0, v1}, Lcom/lenovo/settings/dslv/DragSortController;->distance(Landroid/view/MotionEvent;)F
